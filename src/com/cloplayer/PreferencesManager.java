...
import com.cloplayer.http.HTTPHelper;
import com.cloplayer.utils.SDCardUtilities;
...
public class PreferencesManager extends PreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (isFirstTime) {
			...
			builder.setMessage(
					"Hi, My name is Cloplayer. I am your news reading assistant. Please tell me your email address and the topics you are interested in.")
	...
	public JSONObject all_topics() {
		try {
			return HTTPHelper
					.getUrlContent("http://api.cloplayer.com/api/topics/all");
