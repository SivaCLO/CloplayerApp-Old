...
public class CloreaderService extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Load Pref Page
		Intent i = new Intent(CloreaderService.this, PreferencesManager.class);
    ...
    public void onCreate() {
        super.onCreate();
        Log.i("CloreaderService", "Service Started.");
        showNotification();
    ...
    private void showNotification() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, CloreaderActivity.class), 0);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i("CloreaderService", "Received start id " + startId + ": " + intent);
    ...
    public void onDestroy() {
        ...
        Log.i("CloreaderService", "Service Stopped.");
        isRunning = false;
    }*/
}