...
public class RecognizerTask implements Runnable {
	...
	public RecognizerTask(String dir) {
		
		pocketsphinx
				.setLogfile(dir + "/pocketsphinx.log");
		Config c = new Config();
		/*
		 ...
		 */
		c.setString("-hmm",
				dir + "/hmm/en_US/hub4wsj_sc_8k");	
		c.setString("-dict",
				dir + "/lm/en_US/hub4.5000.dic");
		c.setString("-lm",
				dir + "/lm/en_US/hub4.5000.DMP");
		/*
		c.setString("-hmm",
